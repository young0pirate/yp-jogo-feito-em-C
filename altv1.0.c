...
int main(int argc, char *argv[])
{
	...
	int x, n1, n[2], i,  op;
	int cont, cont1, acert, err, acert1, err1, acert2, err2, rodada;
	cont = 5;
	cont1 = 10;
	acert = acert1 = acert2 = err = err1 = err2 = 0;
	rodada = 0;
  ...
  puts("*****************************************************");
   ...
   system("pause");
	...
	puts("Não fiquem desmoralizados por não terem conseguido acertar sequer uma. O jogo é realmente difícil!\nE se tu conseguiu acertar algumas, estás de parabéns :B.\nAgora, se tu acertou todas, tu és um \"Deus\" da aleatoriedade :P");
		...
		puts("\n\n\2º JOGADOR SAIU VITORIOSO NESSA PARTIDA. PARABÉNS!");
		else if(acert1 ==  acert2)
	...
	do{
	  puts("+++++++++++++++++++++++++++++++++++++++++++++++++++++");
	puts("\t## MODO JOGAR INICIANTE (BATOTEIRO) ##");
	puts("+++++++++++++++++++++++++++++++++++++++++++++++++++++\n\n");
	
	x = rand() % 11;
	printf("O valor que o computador chutou é:\n>>> %d\n",x);
	printf("Chute um númro igual ao do computador:\n>>> ");
	scanf("%d",&n1);
	if(n1 == x)
	puts("PARABÉNS! VOCÊ ACERTOU!");
	else{
	puts("OHHH! INFELIZMENTE VOCÊ ERROU!");
	}
